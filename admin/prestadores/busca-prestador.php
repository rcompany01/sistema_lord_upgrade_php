<?php
$class->ListaPrestadoresID($_GET['cod_prest']);
	while ($row=mysqli_fetch_assoc($class->ListaPrestadoresID)){
?>
		<tr>
			<td style="cursor:pointer" onClick="window.location.href='?funcao=<?= $_GET['funcao'] ?>&idPrest=<?= $row['id_prest'] ?>'"><?= $row['id_prest'] ?></td>
			<td style="cursor:pointer" onClick="window.location.href='?funcao=<?= $_GET['funcao'] ?>&idPrest=<?= $row['id_prest'] ?>'"><?= $row['nome_prest'] ?></td>
			<td style="cursor:pointer" onClick="window.location.href='?funcao=<?= $_GET['funcao'] ?>&idPrest=<?= $row['id_prest'] ?>'"><?= $row['bairro_prest'] ?></td>
