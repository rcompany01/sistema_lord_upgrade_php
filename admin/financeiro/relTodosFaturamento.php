...
<div class="vis-fat">
	<h4 style="margin:20px 0px 0px 0px;font-weight:normal;font-family:tahoma"><b>Cliente:</b> Todos os Clientes - (Faturamento)</h4>
...
<div class="imp-fat">
			...
			<h4 class="rel-fat-txt">Relatório de Faturamento (Todos)</h4>

			<br>

			<h4 style="margin:30px 0px 0px 30px;font-weight:normal;font-family:tahoma"><b>Cliente:</b> Todos os Clientes</h4>
...
?>
	<tr>
		...
		<td><?= $row_fat['saida'] ?></td>
		<td><?= $row_fat['extra'] ?></td>
		<td><?= "R$ ".number_format(round($row_fat['faturamento']),2) ?></td>
		<td><?= "R$ ".$finalExtra ?></td>
...
<div class="form-actions">
	...
	<a href="financeiro/fat-excell-all.php?funcao=FaturamentoRepasse&de=<?= $_POST['de'] ?>&ate=<?= $_POST['ate'] ?>">
