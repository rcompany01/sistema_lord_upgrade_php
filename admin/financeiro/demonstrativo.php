	...
	<div class="cx-demonstrativo">
		<div class="logo_dm">
			...
			<button onClick="window.print()" class="btn btn-primary">
				<u class="icon icon-print icon-white"></u>
			</button>
		...
		*/
		...
		?>
					...
					<tr>
						...
						<td style="text-align:center"><?= $class->NomeFuncao($row['id_funcao']) ?></td>
...
?>
				...
				<div class="cx-final">
					...
					<h4 class="txt-nome-ass"><?= strtoupper($prest->NomePrestador($_GET['Prestador'])) ?></h4>
