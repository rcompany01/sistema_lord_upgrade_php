...
$html .= "</tr>";
	...
	$class->DadosFaturamento($_GET['Cod'], $_GET['de'], $_GET['ate']);
	$faturamento=0;
	$cont=0;
	...
	// CALCULO DE VALOR TOTAL DE FATURAMENTO
		...
		$html .= "<td> R$ ".number_format(round($row_fat['faturamento']),2)."</td>";
...
$html .= "<td>Faturamento : R$ ".number_format($faturamento,2)."</td>";
$html .= "</tr>";
